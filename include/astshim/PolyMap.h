...
public:
    ...
    */
    ...
    /**
    This function creates a new @ref PolyMap which is a copy of the supplied
    @ref PolyMap, in which a specified transformation (forward or inverse)
...
private:
    ...
    AstPolyMap * _makeRawPolyMap(
        ...
        return astPolyMap(nin, nout, ncoeff_f, coeff_f.getData(), 0, NULL, options.c_str());
    }
};
