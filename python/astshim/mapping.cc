...
PYBIND11_PLUGIN(_mapping) {
    py::module mod("_mapping", "Python wrapper for Mapping");
    ...
    cls.def(py::init<AstMapping *>(), "rawMap"_a);
    ...
    // wrap the overloads of tran, tranInverse, tranGridForward and tranGridInverse that return a new result
    cls.def("tran", (Array2D(Mapping::*)(Array2D const &) const) & Mapping::tran, "from"_a);
    cls.def("tranInverse", (Array2D(Mapping::*)(Array2D const &) const) & Mapping::tranInverse, "from"_a);
