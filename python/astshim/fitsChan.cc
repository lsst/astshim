...
PYBIND11_PLUGIN(fitsChan) {
    ...
    cls.def("getFitsCF", &FitsChan::getFitsCF, "name"_a = nullptr, "defval"_a = std::complex<double>(0, 0));
    cls.def("getFitsCN", &FitsChan::getFitsCN, "name"_a = nullptr, "defval"_a = "");
    cls.def("getFitsF", &FitsChan::getFitsF, "name"_a = nullptr, "defval"_a = 0);
    cls.def("getFitsI", &FitsChan::getFitsI, "name"_a = nullptr, "defval"_a = 0);
    cls.def("getFitsL", &FitsChan::getFitsL, "name"_a = nullptr, "defval"_a = false);
    cls.def("getFitsS", &FitsChan::getFitsS, "name"_a = nullptr, "defval"_a = "");
    ...
    cls.def("testFits", &FitsChan::testFits, "name"_a = nullptr);
