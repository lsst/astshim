...
PYBIND11_PLUGIN(keyMap) {
    ...
    cls.def("getB", (char unsigned (KeyMap::*)(std::string const &, int) const) & KeyMap::getB, "key"_a,
            "ind"_a);
    cls.def("getB", (std::vector<char unsigned>(KeyMap::*)(std::string const &) const) & KeyMap::getB,
            "key"_a);
    cls.def("getC", (std::string(KeyMap::*)(std::string const &, int) const) & KeyMap::getC, "key"_a,
            "ind"_a);
    cls.def("getC", (std::vector<std::string>(KeyMap::*)(std::string const &) const) & KeyMap::getC, "key"_a);
    cls.def("getA", (std::shared_ptr<Object>(KeyMap::*)(std::string const &, int) const) & KeyMap::getA,
            "key"_a, "ind"_a);
    cls.def("getA",
            (std::vector<std::shared_ptr<Object>>(KeyMap::*)(std::string const &) const) & KeyMap::getA,
            "key"_a);

    cls.def("putD", (void (KeyMap::*)(std::string const &, double, std::string const &)) & KeyMap::putD,
            "key"_a, "value"_a, "comment"_a = "");
    cls.def("putD",
            (void (KeyMap::*)(std::string const &, std::vector<double> const &, std::string const &)) &
                    KeyMap::putD,
    ...
    cls.def("putS", (void (KeyMap::*)(std::string const &, short int, std::string const &)) & KeyMap::putS,
            "key"_a, "value"_a, "comment"_a = "");
    cls.def("putS",
            (void (KeyMap::*)(std::string const &, std::vector<short int> const &, std::string const &)) &
                    KeyMap::putS,
            "key"_a, "vec"_a, "comment"_a = "");
    cls.def("putB",
            (void (KeyMap::*)(std::string const &, char unsigned, std::string const &)) & KeyMap::putB,
            "key"_a, "value"_a, "comment"_a = "");
    cls.def("putB",
            (void (KeyMap::*)(std::string const &, std::vector<char unsigned> const &, std::string const &)) &
                    KeyMap::putB,
            "key"_a, "vec"_a, "comment"_a = "");
    cls.def("putC",
            (void (KeyMap::*)(std::string const &, std::string const &, std::string const &)) & KeyMap::putC,
            "key"_a, "value"_a, "comment"_a = "");
    cls.def("putC",
            (void (KeyMap::*)(std::string const &, std::vector<std::string> const &, std::string const &)) &
                    KeyMap::putC,
            "key"_a, "vec"_a, "comment"_a = "");
    cls.def("putA",
    ...
    cls.def("append", (void (KeyMap::*)(std::string const &, std::string const &)) & KeyMap::append, "key"_a,
            "value"_a);
    cls.def("append", (void (KeyMap::*)(std::string const &, Object const &)) & KeyMap::append, "key"_a,
            "value"_a);

    // there no need to wrap float, short int and unsigned char versions since the type of the key
    // is already known and the data will be cast
    // list int first, then float because the first match is used
    cls.def("replace", (void (KeyMap::*)(std::string const &, int, int)) & KeyMap::replace, "key"_a, "ind"_a,
            "value"_a);
    cls.def("replace", (void (KeyMap::*)(std::string const &, int, double)) & KeyMap::replace, "key"_a,
            "ind"_a, "value"_a);
    cls.def("replace", (void (KeyMap::*)(std::string const &, int, std::string const &)) & KeyMap::replace,
            "key"_a, "ind"_a, "value"_a);
    cls.def("replace", (void (KeyMap::*)(std::string const &, int, Object const &)) & KeyMap::replace,
            "key"_a, "ind"_a, "value"_a);
