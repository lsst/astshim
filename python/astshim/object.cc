...
PYBIND11_PLUGIN(_object) {
    py::module mod("_object", "Python wrapper for Object");

    py::class_<Object, std::shared_ptr<Object>> cls(mod, "Object");

    cls.def_static("fromString", &Object::fromString);
    cls.def_static("basicFromAstObject", &Object::basicFromAstObject, "rawObj"_a);
    // do not wrap basicFromAstObject or fromAstObject, since they use bare AST pointers
