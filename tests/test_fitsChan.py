...
class TestObject(ObjectTestCase):
    ...
    def test_FitsChanGetFitsSetFits(self):
        ...
        self.assertEqual(fc.getCardType(), astshim.CardType.INT)
        self.assertTrue(fv.found)
        ...
        self.assertEqual(fc.getCardType(), astshim.CardType.FLOAT)
        ...
        self.assertEqual(fc.getCardType(), astshim.CardType.CONTINUE)
        ...
        self.assertEqual(fc.getCardType(), astshim.CardType.COMPLEXF)
        ...
        self.assertEqual(fc.getCardType(), astshim.CardType.LOGICAL)
        ...
        self.assertEqual(fc.getCardType(), astshim.CardType.STRING)
        ...
        self.assertEqual(fc.getCardType(), astshim.CardType.NOTYPE)
        self.assertEqual(fc.getCard(), fc.nCard + 1)
        self.assertFalse(fv.found)

        fc.setCard(7)
        self.assertEqual(fc.getCardType(), astshim.CardType.UNDEF)
        with self.assertRaises(RuntimeError):
            fc.getFitsS()
        self.assertEqual(fc.getCardComm(), "Comment for UNDEFVAL")

        fc.setCard(8)
        self.assertEqual(fc.getCardType(), astshim.CardType.COMMENT)
        with self.assertRaises(RuntimeError):
            fc.getFitsS()
    ...
    def test_FitsChanTestFits(self):
        ...
        self.assertEqual(fc.testFits("AFLOAT"), astshim.PRESENT)
        self.assertEqual(fc.testFits("ASTRING"), astshim.PRESENT)
        self.assertEqual(fc.testFits("UNDEFVAL"), astshim.NOVALUE)
        self.assertEqual(fc.testFits("BADNAME"), astshim.ABSENT)

        fc.setCard(1)
        self.assertEqual(fc.getCardName(), "AFLOAT")
        self.assertEqual(fc.testFits(), astshim.PRESENT)
        fc.setCard(3)
        self.assertEqual(fc.getCardName(), "UNDEFVAL")
        self.assertEqual(fc.testFits(), astshim.NOVALUE)
